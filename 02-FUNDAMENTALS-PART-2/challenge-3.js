...
(Mark Miller and John Smith). Name these objects as mark and
john, and their properties exactly as fullName, mass and height.
...
john.calcBMI() > mark.calcBMI() ? console.log(`John Smith's BMI (${john.bmi}) is higher than Mark Miller's (${mark.bmi})!`) :
